...
try:
    ...
    DEATH_SOUND = pygame.mixer.Sound(os.path.join(ASSETS_DIR, "Music", "Death sound.mp3"))
    HUNDRED_SOUND = pygame.mixer.Sound(os.path.join(ASSETS_DIR, "Music", "Hundred riched sound.mp3"))
